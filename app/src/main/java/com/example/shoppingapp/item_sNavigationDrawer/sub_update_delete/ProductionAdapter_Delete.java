package com.example.shoppingapp.item_sNavigationDrawer.sub_update_delete;
...
public class ProductionAdapter_Delete extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ProductionAdapter_Delete(Context context, List<Production> list) {
